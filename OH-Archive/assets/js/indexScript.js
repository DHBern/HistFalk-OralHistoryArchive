        ...
        data.forEach((object) => {
            ...
            */
            ...
            if (!containsObject(general.isSubjof, collections)) {
                ...
                if(general.isSubjof === '"Schwarzenbach-Abstimmung"' || general.isSubjof === "Saisonnières und Saisonniers" || general.isSubjof === "Wenn Migration die Arbeitsteilung in der Familie prägt"  ){
