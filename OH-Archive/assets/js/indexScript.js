        ...
        data.forEach((object) => {
            ...
            */
            ...
            if (!containsObject(general.isSubjof, collections)) {
                ...
                if(general.isSubjof === '"Schwarzenbach-Abstimmung"' || general.isSubjof === "Saisonnières und Saisonniers" || general.isSubjof === "Über Frauen als Ernährerinnen und Hausmänner: Wenn Migration die Arbeitsteilung in der Familie prägt"  ){
